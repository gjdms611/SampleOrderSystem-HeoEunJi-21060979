...
## 완료 조건
- [x] 생산 1단위마다 재고 실시간 반영 테스트
- [x] 대기 중인 다른 주문 부족분 충족 시 즉시 CONFIRMED 전환 테스트
- [x] PRD 6.2 100ea/20ea 시나리오 테스트 (누적 120에서 20ea 먼저 CONFIRMED, 100ea는 150 전량 완료 시 CONFIRMED)
